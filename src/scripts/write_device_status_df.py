...
def main():
    ...
    write_read_record(result, as_flat_file, folder, config.flat_device_status_csv_file_name, file_type='csv')
    write_read_record(result, as_flat_file, folder, config.flat_device_status_parquet_file_name, file_type='parquet')
